...
describe("Tests the Int64 support", function ()
{
    ...
    it("tests the JSON parse and stringify functionality", function (done)
    {
        ...
        expect(JSONInt64.toDecimalString(parsedObject.int64MinValue)).to.be.equal(
            "-9223372036854775807");
    ...
    it("tests the from/to decimal string conversion utilities", function (done)
    {
        ...
        testCases.forEach(function (stringAndInt64)
        {
            ...
            expect(JSONInt64.fromDecimalString(stringAndInt64[0])).to.be.equalInt64(
                stringAndInt64[1]);
        });
    ...
    it("tests that Int64 objects are recognized even when 'instanceof Int64' returns false", function (done)
    {
        ...
        expect(JSONInt64.parse(JSONInt64.stringify(int64Like))).to.be.equalInt64(
            maxSignedInt64DecimalInt64);
    ...
    it("tests that complex objects are correctly stringified and parsed", function (done)
    {
        ...
        var complexObjectAsString = String.raw `{"a":["foo","\"",9223372036854775807,"    "],"b":{"0":[0,1,2],` +
            ...
            String.raw `"offset":"0"}},"false":false,"null":null,"pi":3.14,"scientific":1.2e+23,"true":true}`;
    ...
    it("tests that fromDecimalString throws an error for too long and too big strings", function (done)
    {
        ...
        assert.throw(
            () => JSONInt64.fromDecimalString(tooBigNumber), RangeError,
            "the magnitude is too large for Int64");
        done();
    });
    ...
    it("tests that parse catches the syntax errors", function (done)
    {
        ...
        testCases.forEach(function (faultyStringAndErrorMessageAndPosition)
        {
            var expectedError = {
